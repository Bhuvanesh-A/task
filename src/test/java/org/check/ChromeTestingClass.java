...
public class ChromeTestingClass extends BaseClass {
	@Parameters({ "browser" })
	@Test(priority = 1)
	public static void login(@Optional("Chrome") String browserName) {
		try {
